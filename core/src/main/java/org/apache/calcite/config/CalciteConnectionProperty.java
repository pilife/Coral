...
public enum CalciteConnectionProperty implements ConnectionProperty {
  ...
  JOIN_THRESHOLD("joinThreshold", Type.NUMBER, 4, false),

  HEURISTIC_THRESHOLD("heuristicThreshold", Type.NUMBER, 6, false),

  SPARK_MASTER_NODE("sparkMasterNode", Type.STRING, "local[4]", false),
